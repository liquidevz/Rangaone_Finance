              ...
              {step === "plan" && (
                <div className="space-y-6">
                  <div className="flex flex-col items-center">
                    ...
                    <div
                      className="max-w-prose mx-auto text-left sm:text-center text-xs sm:text-sm leading-4 sm:leading-5 text-gray-600 break-words prose prose-sm prose-gray max-w-none [&>p]:mb-1 [&>ul]:mb-1 [&>ol]:mb-1 [&>h1]:text-sm [&>h2]:text-sm [&>h3]:text-xs [&>strong]:font-semibold [&>em]:italic"
